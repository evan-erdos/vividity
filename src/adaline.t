...
"Ada used to be so familliar to you. It not like she's unrecognizable, but she is a little colder. " {
	...
	uselessToAttackMsg {
		cls();
		"\b\n\n\n<b>Ada smiles. It is terrifying. \"...waiting was hard.\" she intones. She walks slowly towards you, and then stops. You swing at her, and she defends herself. You notice that she's still smiling, and you are horrified. She is going to kill you if she gets the chance.</b>";
		next;
		"\b\n<b>You seemed to have the upper hand, but when she finally disarmed you, she went much further. She crushes your ribcage with a big stone, and then rolls it upwards, over your skull. You remained alive long enough to see the pleasure in her eyes from dismembering you.</b>";
...
+ adaline_dead : ActorState {
	specialDesc = "Adaline lies prostrate on the carpet, her mortal wounds sharing their colors with the room.";
	stateDesc = "Her skull is cracked, and the left side of her ribcage is crushed and shattered. It is gruesome.";
}
